...
namespace Fingerprint
{
    public partial class frmAluno : Form
    {
        ...
        private List<Aluno> ListaAlunos(int escolaID)
        {
            ...
            return repo.returnListClass("SELECT AlunoID,(Nome + '[' + RA +']') Nome FROM Aluno WHERE EscolaID = @EscolaID", parameter);
        }
        ...
        private void ddlEscola_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            _escolaID = (int)ddlEscola.SelectedValue;
