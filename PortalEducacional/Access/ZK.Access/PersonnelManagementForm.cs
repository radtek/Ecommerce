...
namespace ZK.Access
{
	public class PersonnelManagementForm : Office2007Form
	{
		...
		private Label lab_employmentType;
		...
		private Label lab_employmentDate;
		...
		private DateEdit DTPick_employmentDate;
		...
		private Label lblElevatorProfile;

		private System.Windows.Forms.ComboBox cmbElevatorProfile;
		...
		public PersonnelManagementForm(string cardNo)
			: this()
		{
			this.txt_cardNO.Text = cardNo;
		}

		public PersonnelManagementForm(int id, int parentID, string deptName)
			: this()
		{
			this.m_id = id;
		...
		private void PermissionsType()
		{
			try
			{
				this.m_Permissions = initLang.GetComboxInfo("Permissions");
				if (this.m_Permissions == null || this.m_Permissions.Count == 0)
				{
					this.m_Permissions = new Dictionary<string, Dictionary<string, string>>();
					Dictionary<string, string> dictionary = new Dictionary<string, string>();
					dictionary.Add("0", "一般用户");
					dictionary.Add("1", "超级管理员");
					this.m_Permissions.Add("0", dictionary);
					initLang.SetComboxInfo("Permissions", this.m_Permissions);
					initLang.Save();
				}
			}
			catch (Exception ex)
		...
		private void DataStaff()
		{
			try
			{
				this.cbo_employmentType.Items.Clear();
				this.cbo_type.Items.Clear();
				this.dtGender.Rows.Clear();
				this.cbo_employmentType.Items.Add("-----");
				if (this.m_typeDic != null && this.m_typeDic.ContainsKey("0"))
				{
					Dictionary<string, string> dictionary = this.m_typeDic["0"];
					foreach (KeyValuePair<string, string> item in dictionary)
					{
						this.cbo_employmentType.Items.Add(item.Value);
					}
				}
				this.cbo_type.Items.Add("-----");
				if (this.m_type != null && this.m_type.ContainsKey("0"))
				{
					Dictionary<string, string> dictionary2 = this.m_type["0"];
					foreach (KeyValuePair<string, string> item2 in dictionary2)
					{
						this.cbo_type.Items.Add(item2.Value);
					}
				}
				if (this.m_gender != null && this.m_gender.ContainsKey("0"))
				{
					Dictionary<string, string> dictionary3 = this.m_gender["0"];
					foreach (KeyValuePair<string, string> item3 in dictionary3)
					{
						DataRow dataRow = this.dtGender.NewRow();
						dataRow["Value"] = item3.Key.ToUpper().Trim();
						dataRow["Text"] = item3.Value;
						this.dtGender.Rows.Add(dataRow);
					}
				}
				if (this.m_Permissions != null && this.m_Permissions.ContainsKey("0"))
				{
					Dictionary<string, string> dictionary4 = this.m_Permissions["0"];
					foreach (KeyValuePair<string, string> item4 in dictionary4)
					{
						this.cbo_Permissions.Items.Add(item4.Value);
					}
				}
				if (this.cbo_employmentType.Items.Count > 0)
				{
					this.cbo_employmentType.SelectedIndex = 0;
				}
				if (this.cbo_type.Items.Count > 0)
				{
					this.cbo_type.SelectedIndex = 0;
				}
				this.cbo_gender.SelectedValue = "M";
				if (this.cbo_Permissions.Items.Count > 0)
				{
					this.cbo_Permissions.SelectedIndex = 0;
				}
			}
			catch (Exception ex)
			{
			...
			try
			{
				...
				if (this.m_id > 0)
				{
					...
					if (userInfo != null)
					{
						...
						this.cmbElevatorProfile.Text = userInfo.elevatorProfile;
						...
						this.cbo_dept.Items.Add(this.m_deptName);
						this.cbo_dept.Text = this.m_deptName;
						this.txt_cardNO.Text = userInfo.CardNo;
						...
						case 0:
							...
							break;
						case 14:
							this.cbo_Permissions.SelectedIndex = 1;
							break;
						default:
							this.cbo_Permissions.SelectedIndex = 0;
							break;
						}
						this.deptID = userInfo.DefaultDeptId;
						...
						DateEdit dTPick_employmentDate = this.DTPick_employmentDate;
						nullable = userInfo.HiredDay;
						DateTime dateTime2;
						if (nullable.HasValue)
						{
							nullable = userInfo.HiredDay;
						...
						dTPick_employmentDate.EditValue = dateTime2;
						...
						if (this.cbo_employmentType.Items.Count > userInfo.HireType)
						{
							this.cbo_employmentType.SelectedIndex = userInfo.HireType;
						}
						if (this.cbo_type.Items.Count > userInfo.EmpType)
						{
							this.cbo_type.SelectedIndex = userInfo.EmpType;
						}
				...
				{
					this.DTPick_employmentDate.EditValue = DateTime.Now;
		...
		private bool CheckData()
		{
			try
			{
				...
				if (userInfo == null)
				{
					...
					{
						SysDialogs.ShowWarningMessage(ShowMsgInfos.GetInfo("deptNumberNotNull", "部门不能为空"));
						this.cbo_dept.Focus();
						return false;
					}
		...
		private void SetModel(UserInfo model)
		{
			try
			{
				if (this.chk_setValidTime.Checked)
				{
				...
				{
					model.AccStartDate = null;
					model.AccEndDate = null;
				}
				if (!string.IsNullOrEmpty(this.cmbElevatorProfile.Text.Trim()))
				{
					model.elevatorProfile = this.cmbElevatorProfile.Text;
				}
				...
				if (!string.IsNullOrEmpty(this.cbo_dept.Text.Trim()))
				{
				...
				model.HiredDay = DateTime.Parse(this.DTPick_employmentDate.Text);
				...
				model.HireType = this.cbo_employmentType.SelectedIndex;
				model.EmpType = this.cbo_type.SelectedIndex;
				switch (this.cbo_Permissions.SelectedIndex)
				{
				case 0:
					model.Privilege = 0;
					break;
		...
		private void CheckLevelChange(UserInfo newUser, UserInfo oldUser, int TemplateCount)
		{
			...
			List<AccLevelset> modelList4 = accLevelsetBll.GetModelList("");
			if (modelList4 != null)
			{
			...
			if (!string.IsNullOrEmpty(this.newEmpLevelIDs) || !string.IsNullOrEmpty(this.oldEmpLevelIDs))
			{
				...
				if (!string.IsNullOrEmpty(this.newEmpLevelIDs) && !string.IsNullOrEmpty(this.oldEmpLevelIDs))
				{
					if (this.newEmpLevelIDs == this.oldEmpLevelIDs)
					{
						if (newUser.CardNo != oldUser.CardNo || newUser.AccStartDate != oldUser.AccStartDate || newUser.AccEndDate != oldUser.AccEndDate || newUser.MorecardGroupId != oldUser.MorecardGroupId || newUser.Privilege != oldUser.Privilege || newUser.PassWord != oldUser.PassWord || newUser.Name != oldUser.Name || this.isClickTemplateBtn)
						{
							for (int m = 0; m < this.levelMachines.Count; m++)
							{
								...
								{
									CommandServer.DeleteFace(this.levelMachines[m], list, true, out text);
									CommandServer.DeleteFingerVein(this.levelMachines[m], list, true, out text);
									CommandServer.DeleteFingerPrint(this.levelMachines[m], list, true, out text);
									CommandServer.DeleteUserAuthorize(this.levelMachines[m], list, true, out text);
								}
								CommandServer.DeleteUser(this.levelMachines[m], list, true, out text);
								...
								modelList4 = accLevelsetBll.GetModelList("id in (select acclevelset_id from acc_levelset_door_group where accdoor_device_id=" + this.levelMachines[m].ID + ") and id in(select acclevelset_id from acc_levelset_emp where employee_id=" + newUser.UserId + ")");
								if (modelList4 != null)
								{
					...
					else
					{
						for (int num = 0; num < this.oldLevelMachines.Count; num++)
						{
							...
							{
								CommandServer.DeleteFace(this.oldLevelMachines[num], list, true, out text);
								CommandServer.DeleteFingerVein(this.oldLevelMachines[num], list, true, out text);
								CommandServer.DeleteFingerPrint(this.oldLevelMachines[num], list, true, out text);
								CommandServer.DeleteUserAuthorize(this.oldLevelMachines[num], list, true, out text);
							}
							CommandServer.DeleteUser(this.oldLevelMachines[num], list, true, out text);
						}
						for (int num2 = 0; num2 < this.levelMachines.Count; num2++)
						{
							...
							modelList4 = accLevelsetBll.GetModelList("id in (select acclevelset_id from acc_levelset_door_group where accdoor_device_id=" + this.levelMachines[num2].ID + ") and id in(select acclevelset_id from acc_levelset_emp where employee_id=" + newUser.UserId + ")");
							if (modelList4 != null)
							{
				...
				else if (!string.IsNullOrEmpty(this.newEmpLevelIDs) && string.IsNullOrEmpty(this.oldEmpLevelIDs))
				{
					for (int num4 = 0; num4 < this.levelMachines.Count; num4++)
					{
						...
						modelList4 = accLevelsetBll.GetModelList("id in (select acclevelset_id from acc_levelset_door_group where accdoor_device_id=" + this.levelMachines[num4].ID + ") and id in(select acclevelset_id from acc_levelset_emp where employee_id=" + newUser.UserId + ")");
						if (modelList4 != null)
						{
				...
				else if (string.IsNullOrEmpty(this.newEmpLevelIDs) && !string.IsNullOrEmpty(this.oldEmpLevelIDs))
				{
					for (int num6 = 0; num6 < this.oldLevelMachines.Count; num6++)
					{
						...
						{
							CommandServer.DeleteFace(this.oldLevelMachines[num6], list, true, out text);
							CommandServer.DeleteFingerVein(this.oldLevelMachines[num6], list, true, out text);
							CommandServer.DeleteFingerPrint(this.oldLevelMachines[num6], list, true, out text);
							CommandServer.DeleteUserAuthorize(this.oldLevelMachines[num6], list, true, out text);
						}
						CommandServer.DeleteUser(this.oldLevelMachines[num6], list, true, out text);
					}
					FrmShowUpdata.Instance.ShowEx();
				}
			}
			...
			try
			{
				if (this.CheckData())
				{
					...
					else
					{
						try
						{
							this.userInfoBll.Add(userInfo, "N");
		...
		private void frm_SelectDeptEvent(object sender, EventArgs e)
		{
			if (sender != null)
			{
				...
				if (departments != null)
				{
					this.cbo_dept.Items.Clear();
					this.cbo_dept.Items.Add(departments.DEPTNAME);
					this.cbo_dept.SelectedIndex = 0;
		...
		private void btn_saveContinue_Click(object sender, EventArgs e)
		{
			if (this.Save())
			{
				try
				{
					...
					this.DTPick_employmentDate.Text = "";
					...
					if (this.cbo_dept.Items.Count > 0)
					{
						this.cbo_dept.SelectedIndex = 0;
					}
					this.CheckBtn();
				...
				if (info != null && (info.EType == EventType.Type27 || info.EType == EventType.Type1027) && !string.IsNullOrEmpty(info.CardNo))
				{
					...
					if (flag)
					{
						if (info.CardNo != "0")
						{
							...
							{
								uint num3 = (uint)num2;
								if (DeviceTreeForm.is26BitsKeys)
								{
									num3 &= 0xFFFFFF;
								}
								else if (DeviceTreeForm.is34BitsKeys)
								{
		...
		private void link_read_LinkClicked(object sender, EventArgs e)
		{
			if (this.readStart)
			{
				DeviceTreeForm.showBitsKey = true;
		...
		private void DTPick_employmentDate_EditValueChanged(object sender, EventArgs e)
		{
			if (this.DTPick_employmentDate.EditValue == null)
			{
				this.DTPick_employmentDate.EditValue = DateTime.Now;
			}
			DateTime t = (DateTime)this.DTPick_employmentDate.EditValue;
			if (t > DateTime.Now)
			{
				this.DTPick_employmentDate.EditValue = DateTime.Now;
			}
		...
		private void InitializeComponent()
		{
			...
			this.lblElevatorProfile = new Label();
			this.cmbElevatorProfile = new System.Windows.Forms.ComboBox();
			...
			this.DTPick_employmentDate = new DateEdit();
			...
			this.lab_type = new Label();
			this.lab_employmentType = new Label();
			...
			((ISupportInitialize)this.DTPick_employmentDate.Properties.CalendarTimeProperties).BeginInit();
			((ISupportInitialize)this.DTPick_employmentDate.Properties).BeginInit();
			...
			this.tabControl1.Size = new Size(852, 460);
			...
			this.tabControlPanel3.Size = new Size(852, 434);
			...
			this.panel1.Controls.Add(this.lblElevatorProfile);
			this.panel1.Controls.Add(this.cmbElevatorProfile);
			this.panel1.Controls.Add(this.lblElevatorFloor);
			this.panel1.Controls.Add(this.txtDefaultFloor);
			this.panel1.Location = new Point(4, 370);
			this.panel1.Name = "panel1";
			this.panel1.Size = new Size(828, 64);
			this.panel1.TabIndex = 92;
			this.lblElevatorSpecialNeeds.AutoSize = true;
			this.lblElevatorSpecialNeeds.Location = new Point(40, 45);
			this.lblElevatorSpecialNeeds.Name = "lblElevatorSpecialNeeds";
			this.lblElevatorSpecialNeeds.Size = new Size(141, 13);
			this.lblElevatorSpecialNeeds.TabIndex = 93;
			this.lblElevatorSpecialNeeds.Text = "Portador de Nesc. Especiais";
			this.chkElevatorSpecialNeeds.AutoSize = true;
			this.chkElevatorSpecialNeeds.Location = new Point(213, 45);
			this.chkElevatorSpecialNeeds.Name = "chkElevatorSpecialNeeds";
			this.chkElevatorSpecialNeeds.Size = new Size(15, 14);
			this.chkElevatorSpecialNeeds.TabIndex = 92;
			this.chkElevatorSpecialNeeds.UseVisualStyleBackColor = true;
			this.lblElevatorProfile.AutoSize = true;
			this.lblElevatorProfile.BackColor = Color.Transparent;
			this.lblElevatorProfile.Location = new Point(40, 16);
			this.lblElevatorProfile.Name = "lblElevatorProfile";
			this.lblElevatorProfile.Size = new Size(75, 13);
			this.lblElevatorProfile.TabIndex = 88;
			this.lblElevatorProfile.Text = "Perfil Elevador";
			this.cmbElevatorProfile.DropDownStyle = ComboBoxStyle.DropDownList;
			this.cmbElevatorProfile.FormattingEnabled = true;
			this.cmbElevatorProfile.Items.AddRange(new object[6]
			{
				"GERAL",
				"SERVICO",
				"VIP",
			...
			this.cmbElevatorProfile.Location = new Point(210, 13);
			this.cmbElevatorProfile.Name = "cmbElevatorProfile";
			this.cmbElevatorProfile.Size = new Size(121, 21);
			this.cmbElevatorProfile.TabIndex = 91;
			this.lblElevatorFloor.AutoSize = true;
			this.lblElevatorFloor.BackColor = Color.Transparent;
			this.lblElevatorFloor.Location = new Point(450, 16);
			this.lblElevatorFloor.Name = "lblElevatorFloor";
			this.lblElevatorFloor.Size = new Size(89, 13);
			this.lblElevatorFloor.TabIndex = 89;
			this.lblElevatorFloor.Text = "Andar de Destino";
			this.txtDefaultFloor.Location = new Point(607, 13);
			this.txtDefaultFloor.Name = "txtDefaultFloor";
			this.txtDefaultFloor.Size = new Size(122, 20);
			this.txtDefaultFloor.TabIndex = 90;
			...
			this.cbo_datEnd.Enabled = false;
			this.cbo_datEnd.Location = new Point(611, 338);
			...
			this.lnk_ClearAntyBack.Size = new Size(79, 13);
			this.lnk_ClearAntyBack.TabIndex = 28;
			this.lnk_ClearAntyBack.TabStop = true;
			this.lnk_ClearAntyBack.Text = "清空反潜状态";
			...
			this.lab_multiCard.Text = "多卡开门人员组";
			...
			this.lab_setValidTime.Text = "设置有效时间";
			...
			this.column_selectedLevel.Caption = "权限组名称";
			...
			this.column_selectedTime.Caption = "门禁时间段";
			...
			this.tabControlPanel1.Controls.Add(this.lab_Permissions);
			...
			this.tabControlPanel1.Controls.Add(this.lab_employmentDate);
			...
			this.tabControlPanel1.Controls.Add(this.lab_dept);
			...
			this.tabControlPanel1.Size = new Size(852, 434);
			...
			this.buttonX2.Location = new Point(708, 258);
			...
			this.buttonX1.Location = new Point(708, 231);
			...
			this.DTPick_employmentDate.EditValue = null;
			this.DTPick_employmentDate.Location = new Point(457, 155);
			this.DTPick_employmentDate.Name = "DTPick_employmentDate";
			this.DTPick_employmentDate.Properties.Buttons.AddRange(new EditorButton[1]
			{
				new EditorButton(ButtonPredefines.Combo)
			});
			this.DTPick_employmentDate.Properties.CalendarTimeProperties.Buttons.AddRange(new EditorButton[1]
			{
				new EditorButton()
			});
			this.DTPick_employmentDate.Properties.Mask.EditMask = "yyyy-MM-dd";
			this.DTPick_employmentDate.Properties.Mask.UseMaskAsDisplayFormat = true;
			this.DTPick_employmentDate.Size = new Size(119, 20);
			this.DTPick_employmentDate.TabIndex = 83;
			this.DTPick_employmentDate.EditValueChanged += this.DTPick_employmentDate_EditValueChanged;
			this.DTPick_birthday.EditValue = null;
			this.DTPick_birthday.Location = new Point(457, 202);
			...
			this.btnFPCollector.Text = "Cad. Mesa";
			...
			this.btnMachine.Text = "Dispositivo";
			...
			this.lblIDReaderFailed.Size = new Size(91, 13);
			this.lblIDReaderFailed.TabIndex = 82;
			this.lblIDReaderFailed.Text = "阅读器连接失败";
			this.lblIDReaderFailed.Visible = false;
			this.cbo_Permissions.FormattingEnabled = true;
			this.cbo_Permissions.Location = new Point(457, 251);
			this.cbo_Permissions.Name = "cbo_Permissions";
			this.cbo_Permissions.Size = new Size(122, 21);
			this.cbo_Permissions.TabIndex = 12;
			this.txt_mobilPhone.Location = new Point(457, 112);
			...
			this.txt_cardNO.Location = new Point(457, 65);
			...
			this.cbo_dept.Location = new Point(457, 18);
			this.cbo_dept.Name = "cbo_dept";
			this.cbo_dept.Size = new Size(121, 21);
			this.cbo_dept.TabIndex = 2;
			this.cbo_dept.Click += this.cbo_dept_Click;
			this.txt_email.Location = new Point(136, 251);
			this.txt_email.Name = "txt_email";
			this.txt_email.Size = new Size(121, 20);
			...
			this.flowLayoutPanel1.Location = new Point(584, 62);
			...
			this.pic_Readding.Visible = false;
			this.lab_Permissions.BackColor = Color.Transparent;
			this.lab_Permissions.Location = new Point(313, 255);
			this.lab_Permissions.Name = "lab_Permissions";
			this.lab_Permissions.RightToLeft = RightToLeft.No;
			this.lab_Permissions.Size = new Size(133, 15);
			this.lab_Permissions.TabIndex = 78;
			this.lab_Permissions.Text = "设备操作权限";
			this.lab_Permissions.TextAlign = ContentAlignment.MiddleLeft;
			...
			this.lbl_picture.Text = "(最佳尺寸为120×140像素)";
			...
			this.lab_birthday.Text = "出生日期";
			this.lab_birthday.TextAlign = ContentAlignment.MiddleLeft;
			this.lab_employmentDate.BackColor = Color.Transparent;
			this.lab_employmentDate.Location = new Point(313, 161);
			this.lab_employmentDate.Name = "lab_employmentDate";
			this.lab_employmentDate.RightToLeft = RightToLeft.No;
			this.lab_employmentDate.Size = new Size(133, 13);
			this.lab_employmentDate.TabIndex = 26;
			this.lab_employmentDate.Text = "聘用日期";
			this.lab_employmentDate.TextAlign = ContentAlignment.MiddleLeft;
			this.lab_mobilePhone.BackColor = Color.Transparent;
			this.lab_mobilePhone.Location = new Point(313, 116);
			...
			this.label2.Location = new Point(583, 23);
			...
			this.lab_dept.BackColor = Color.Transparent;
			this.lab_dept.Location = new Point(313, 23);
			this.lab_dept.Name = "lab_dept";
			this.lab_dept.RightToLeft = RightToLeft.No;
			this.lab_dept.Size = new Size(133, 13);
			this.lab_dept.TabIndex = 18;
			this.lab_dept.Text = "部门";
			this.lab_dept.TextAlign = ContentAlignment.MiddleLeft;
			...
			this.lab_cardNO.Location = new Point(313, 69);
			...
			this.tabControlPanel2.Controls.Add(this.cbo_type);
			this.tabControlPanel2.Controls.Add(this.cbo_employmentType);
			...
			this.tabControlPanel2.Controls.Add(this.lab_type);
			this.tabControlPanel2.Controls.Add(this.lab_employmentType);
			...
			this.tabControlPanel2.Size = new Size(852, 434);
			...
			this.cbo_type.Location = new Point(503, 343);
			this.cbo_type.Name = "cbo_type";
			this.cbo_type.Size = new Size(162, 21);
			this.cbo_type.TabIndex = 5;
			this.cbo_type.Visible = false;
			this.cbo_employmentType.FormattingEnabled = true;
			this.cbo_employmentType.Location = new Point(142, 343);
			this.cbo_employmentType.Name = "cbo_employmentType";
			this.cbo_employmentType.Size = new Size(162, 21);
			this.cbo_employmentType.TabIndex = 3;
			...
			this.lab_homeAddress.Text = "家庭地址";
			...
			this.lab_workAddress.Text = "办公地址";
			...
			this.lab_homeTelephone.Text = "家庭电话";
			...
			this.lab_officeTelephone.Text = "办公电话";
			...
			this.lab_politicalStatus.Text = "政治面貌";
			this.lab_politicalStatus.TextAlign = ContentAlignment.MiddleLeft;
			this.lab_type.BackColor = Color.Transparent;
			this.lab_type.Location = new Point(405, 346);
			this.lab_type.Name = "lab_type";
			this.lab_type.Size = new Size(92, 13);
			this.lab_type.TabIndex = 25;
			this.lab_type.Text = "员工类型";
			this.lab_type.TextAlign = ContentAlignment.MiddleLeft;
			this.lab_type.Visible = false;
			this.lab_employmentType.BackColor = Color.Transparent;
			this.lab_employmentType.Location = new Point(44, 346);
			this.lab_employmentType.Name = "lab_employmentType";
			this.lab_employmentType.Size = new Size(92, 13);
			this.lab_employmentType.TabIndex = 23;
			this.lab_employmentType.Text = "雇佣类型";
			this.lab_employmentType.TextAlign = ContentAlignment.MiddleLeft;
			this.lab_employmentType.Visible = false;
			...
			this.tabItem_detail.Text = "详细资料";
			this.btn_cancel.AccessibleRole = AccessibleRole.PushButton;
			this.btn_cancel.ColorTable = eButtonColor.OrangeWithBackground;
			this.btn_cancel.Location = new Point(677, 468);
			...
			this.btn_ok.Location = new Point(506, 468);
			...
			this.btn_saveContinue.Location = new Point(334, 468);
			...
			base.ClientSize = new Size(851, 501);
			...
			base.Name = "PersonnelManagementForm";
			...
			((ISupportInitialize)this.DTPick_employmentDate.Properties.CalendarTimeProperties).EndInit();
			((ISupportInitialize)this.DTPick_employmentDate.Properties).EndInit();
